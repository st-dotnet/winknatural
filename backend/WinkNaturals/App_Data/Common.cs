...
namespace Resources
{
    ...
    public static class Common
    {
       ...
       ///</summary>
        ...
        {
            return DbResourceProvider.GetResourceValue( Thread.CurrentThread.CurrentUICulture.Name, resourceName);
        } 

        private static string GetCarouselObject(string resourceName, CultureInfo culture, Dictionary<string,string> filters)
        {
            return DbResourceProvider.GetCarouselObject("Common", culture.Name, resourceName, filters);
        } 
        ...
        {
            return DbResourceProvider.ValueInList(culture.Name, resourceName, valueToCompare);
        }
    }
}